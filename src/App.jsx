...
        isCourseType = true;
        reason = `ชำระเงินซ้ำ (${customer.visitCount} ครั้ง)`;
      } else if (customer.hasCourseItem) {
        isCourseType = true;
...
      } else {
        isCourseType = false;
        reason = "ชำระ 1 ครั้ง (สินค้าทั่วไป)";
      }
...
            </h1>
            <p className="text-slate-500 text-sm">ตรวจสอบรายการสินค้าเชิงลึกแยกตามรายบุคคล</p>
          </div>
          
...
                        <div className={`inline-flex flex-col items-center justify-center w-8 h-8 rounded-lg ${c.visitCount >= 2 ? 'bg-purple-50 text-purple-600' : 'bg-slate-50 text-slate-400'}`}>
...
            <div>
              <h4 className="text-xs font-bold text-slate-800 mb-1">ทำไมลูกค้า 1 ครั้งถึงเป็น "คอร์ส"?</h4>
              <p className="text-[10px] text-slate-500 leading-relaxed">
                เพราะในรายการสินค้าพบคีย์เวิร์ด <b className="text-purple-600">"คอร์ส/Package"</b> หรือในช่องจำนวนระบุ <b className="text-purple-600">มากกว่า 1</b> ซึ่งถือเป็นการซื้อเหมาหรือแพ็กเกจในบิลเดียว
              </p>
            </div>
          </div>
          <div className="bg-white p-4 rounded-2xl border border-slate-100 flex-1 flex items-start gap-3">
...
            <div>
              <h4 className="text-xs font-bold text-slate-800 mb-1">การจัดกลุ่มลูกค้าซื้อครั้งเดียว</h4>
              <p className="text-[10px] text-slate-500 leading-relaxed">
                ระบบจะนับเป็น <b className="text-blue-600">"ซื้อครั้งเดียว"</b> เฉพาะลูกค้าที่ชำระเงินเพียง 1 ครั้ง และรายการที่ซื้อระบุจำนวนเป็น 1 และไม่มีคีย์เวิร์ดที่เกี่ยวกับคอร์สเท่านั้น
              </p>
            </div>
          </div>
        </div>
